...
Screen readers cannot describe an icon based on their appearance, they can only read its text alternative. In Compose this is
...
Implementation of this: Instagram gives its action buttons descriptive labels
