...
While core semantics make a single component correct, advanced semantics make a screen pleasant:
...
actually comfortable to navigate with fixed action mechanisms e.g. keyboard movement, swipe-based movement.
...
There are two modifiers that let us prune the tree:
