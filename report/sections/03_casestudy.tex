...
in-memory mock implements the \code{PodcastRepository} interface, so the UI code is byte-for-byte
identical to a real-backend version but runs anywhere with no configuration.
